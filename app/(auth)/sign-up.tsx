  ...
  return (
    <Screen>
      ...
      <View style={styles.header}>
        ...
        <Button title={status === 'loading' ? 'Creating...' : 'Sign Up'} onPress={onSubmit} loading={status === 'loading'} />
        <Link href="/(auth)/sign-in"><Text style={styles.linkCenter}>Already have an account? Sign in</Text></Link>
